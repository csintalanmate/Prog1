...
int main()
{
    ...
    int min_hossz = 8, max_hossz = 12, jelszo_hossz;
    char jelszo[max_hossz + 1];
    int fajta, elozo = -1;
    int kisbetu = 0, nagybetu = 0, szam = 0, specialis = 0;
    int i;
    ...
    do
    {
        ...
        for (i = 0; i < jelszo_hossz; i++)
        {
            ...
            switch (fajta)
            {
                case 0: jelszo[i] = 'a' + get_random(0,25);
                kisbetu = 1; break;
                case 1: jelszo[i] = 'A' + get_random(0,25);
                nagybetu = 1; break;
                case 2: jelszo[i] = '0' + get_random(0,9);
                szam = 1; break;
                case 3: jelszo[i] = SPECIAL[get_random(0,meret-1)];
                specialis = 1; break;
            }
            elozo = fajta;
        }
